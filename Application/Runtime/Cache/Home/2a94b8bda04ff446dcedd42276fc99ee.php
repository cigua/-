...
<head>
    ...
    <link rel="stylesheet" href="/myweibo/Public/Theme<?php echo ($style); ?>/Css/Index.css" />
    <link rel="stylesheet" href="/myweibo/Public/Theme<?php echo ($style); ?>/Css/nav.css" />
    <link rel="stylesheet" href="/myweibo/Public/Theme<?php echo ($style); ?>/Css/bottom.css" />
    <link rel="stylesheet" href="/myweibo/Public/Uploadify/uploadify.css"/>
    <script type="text/javascript" src='/myweibo/Public/Js/jquery-1.7.2.min.js'></script>
    <script type="text/javascript" src='/myweibo/Public/Js/nav.js'></script>
    <script type="text/javascript" src='/myweibo/Public/Uploadify/jquery.uploadify.min.js'></script>
    <script type="text/javascript" src='/myweibo/Public/Js/index.js'></script>
    <script type='text/javascript'>
        var PUBLIC = '/myweibo/Public';
...
<div style='height:60px;opcity:10'></div>
    ...
    <div id="left" class='fleft'>
        ...
        <div class="group">
            ...
            <ul>
                <?php $group = M("group")->where(array('uid' => session('uid')))->select(); ?>
                <li><a href="/myweibo"><i class='icon icon-group'></i>&nbsp;&nbsp;全部</a></li>
            ...
            <div class="weibo">
                ...
                <div class="face">
                    <a href="<?php echo U('/' . $v['uid']);?>">
                        <img src="
                        <?php if($v["face"]): ?>/myweibo/Uploads/Face/<?php echo ($v["face"]); ?>
                        <?php else: ?>
                            /myweibo/Public/images/noface.gif<?php endif; ?>" width='60' height='60'/>
                    </a>
                </div>
                <div class="wb_cons">
                    <dl>
                    ...
                    <?php if($v['max']): ?><dd>
                            <div class='wb_img'>
                            <!--小图-->
                                <img src="/myweibo/Uploads/Pic/<?php echo ($v["mini"]); ?>" class='mini_img'/>
                                <div class="img_tool hidden">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <a href="/myweibo/Uploads/Pic/<?php echo ($v["max"]); ?>" target='_blank'>&nbsp;查看大图</a>
                                        </li>
                                    </ul>
                                <!--中图-->
                                    <div class="img_info"><img src="/myweibo/Uploads/Pic/<?php echo ($v["medium"]); ?>"/></div>
                                </div>
                            </div>
                        </dd><?php endif; ?>
                    </dl>
                ...
                <!--=====回复框=====-->
                    <div class='comment_load hidden'>
                        <img src="/myweibo/Public/images/loading.gif">评论加载中，请稍候...
                    </div>
            ...
            <!--头像-->
                <div class="face">
                    <a href="<?php echo U('/' . $v['uid']);?>">
                        ...
                        <?php if($v["face"]): ?>/myweibo/Uploads/Face/<?php echo ($v["face"]); ?>
                        <?php else: ?>
                            /myweibo/Public/images/noface.gif<?php endif; ?>" width='50' height='50'/>
                    </a>
                </div>
                <div class="wb_cons">
                    <dl>
                        ...
                        <dd>
                            <div class="wb_turn">
                                ...
                                <?php if($v["isturn"]["max"]): ?><dd>
                                        <div class="turn_img">
                                        <!--小图-->
                                            <img src="/myweibo/Uploads/Pic/<?php echo ($v["isturn"]["mini"]); ?>" class='turn_mini_img'/>
                                            <div class="turn_img_tool hidden">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <i class='icon icon-bigpic'></i>
                                                        <a href="/myweibo/Uploads/Pic/<?php echo ($v["isturn"]["max"]); ?>" target='_blank'>&nbsp;查看大图</a>
                                                    </li>
                                                </ul>
                                            <!--中图-->
                                                <div class="turn_img_info">
                                                    <img src="/myweibo/Uploads/Pic/<?php echo ($v["isturn"]["medium"]); ?>"/>
                                                </div>
                                            </div>
                                        </div>
                                    </dd><?php endif; ?>
...
#right .maybe fieldset{
    border:0;
    border-top:1px solid #E6E6E6;
    padding-left:15px;
}
#right .maybe fieldset legend{
    padding:0 5px;
    color:#333333;
    font-weight: bold;
}
#right .maybe fieldset ul{
    padding-top:10px;
}
#right .maybe fieldset ul li{
    height: 30px;
    padding:10px 5px;
}
#right .maybe fieldset ul li dl{
    width:140px;
    height:30px;
    float: left;
}
#right .maybe fieldset ul li dl dt{
    width:30px;
    height:30px;
    margin-right:10px;
    float: left;
}
#right .maybe fieldset ul li dl dd{
    width:100px;
    height:15px;
    line-height: 15px;
    color:#2B96E1;
...
#right .maybe fieldset ul li dl dd a{
    color:#333333;
}
#right .maybe fieldset ul li dl dd a:hover{
    color:#2B96E5;
}
#right .maybe fieldset ul li .heed_btn{
...
#right .maybe fieldset ul li .heed_btn strong{
    font-weight: bold;
    font-size: 14px;
    color:#FDAE2A;
}
...
<?php
 $m_user=M('Userinfo'); $where=['uid'=>session('uid')]; $userinfo=$m_user->where($where)->find(); ?>
<div id='$_SESSION["uid"]'>
    <dl class="user_face">
        <dt>
            <a href="<?php echo U('/' . $userinfo['uid']);?>">
                <img src="<?php if($userinfo["face80"]): ?>/myweibo/Uploads/Face/<?php echo ($userinfo["face80"]); else: ?>/myweibo/Public/Images/noface.gif<?php endif; ?>" width='80' height='80' alt="<?php echo ($username); ?>" />
            </a>
        </dt>
        <dd>
    ...
    <div class="maybe">
            ...
            <ul>
                <maybe uid='$_SESSION["uid"]'>
                    <?php if(is_array($inster_list)): foreach($inster_list as $key=>$v): ?><li>
                        <dl>
                            <dt>
                                <a href="<?php echo U('/' . $v['uid']);?>">
                                    <img src="<?php if($v.face50): ?>/myweibo/Uploads/Face/<?php echo ($v["face50"]); else: ?>/myweibo/Public/Images/noface.gif<?php endif; ?>" width='30' height='30'/>
                                </a>
                            </dt>
    ...
    <div class="maybe">
            <fieldset>
            <legend>活跃用户排行</legend>
            <ul>
                
                    <?php if(is_array($hot_user_list)): foreach($hot_user_list as $key=>$v): ?><li>
                        <dl>
                            <dt>
                                <a href="<?php echo U('/' . $v['uid']);?>">
                                    <img src="<?php if($v.face50): ?>/myweibo/Uploads/Face/<?php echo ($v["face50"]); else: ?>/myweibo/Public/Images/noface.gif<?php endif; ?>" width='30' height='30'/>
     ...
     <div class="maybe">
            <fieldset>
            <legend>最新注册用户</legend>
            <ul>
                
                    <?php if(is_array($new_user_list)): foreach($new_user_list as $key=>$v): ?><li>
                        <dl>
                            <dt>
                                <a href="<?php echo U('/' . $v['uid']);?>">
                                    <img src="<?php if($v.face50): ?>/myweibo/Uploads/Face/<?php echo ($v["face50"]); else: ?>/myweibo/Public/Images/noface.gif<?php endif; ?>" width='30' height='30'/>
...
<!--==========底部==========-->
<!--==========底部==========-->
    <div id="bottom" style='margin-top:0px; border-top:1px solid #ccc'>
        <div class='link'>
            <dl>
                <dt>友情链接</dt>
                <dd><a href="">友情链接</a></dd>
        ...
        <div id="copy">
            <div>
                <p>
                    版权所有： 京ICP备10027771号-1 站长统计 All rights reserved, houdunwang.com services for Beijing 2008-2012 
                </p>
            </div>
        </div>
    </div>
...
<!--==========表情选择框==========-->
    <div id="phiz" class='hidden'>
        ...
        <ul>
            <li><img src="/myweibo/Public/images/phiz/hehe.gif" alt="呵呵" title="呵呵" /></li>
            <li><img src="/myweibo/Public/images/phiz/xixi.gif" alt="嘻嘻" title="嘻嘻" /></li>
            <li><img src="/myweibo/Public/images/phiz/haha.gif" alt="哈哈" title="哈哈" /></li>
            <li><img src="/myweibo/Public/images/phiz/keai.gif" alt="可爱" title="可爱" /></li>
            <li><img src="/myweibo/Public/images/phiz/kelian.gif" alt="可怜" title="可怜" /></li>
            <li><img src="/myweibo/Public/images/phiz/wabisi.gif" alt="挖鼻屎" title="挖鼻屎" /></li>
            <li><img src="/myweibo/Public/images/phiz/chijing.gif" alt="吃惊" title="吃惊" /></li>
            <li><img src="/myweibo/Public/images/phiz/haixiu.gif" alt="害羞" title="害羞" /></li>
            <li><img src="/myweibo/Public/images/phiz/jiyan.gif" alt="挤眼" title="挤眼" /></li>
            <li><img src="/myweibo/Public/images/phiz/bizui.gif" alt="闭嘴" title="闭嘴" /></li>
            <li><img src="/myweibo/Public/images/phiz/bishi.gif" alt="鄙视" title="鄙视" /></li>
            <li><img src="/myweibo/Public/images/phiz/aini.gif" alt="爱你" title="爱你" /></li>
            <li><img src="/myweibo/Public/images/phiz/lei.gif" alt="泪" title="泪" /></li>
            <li><img src="/myweibo/Public/images/phiz/touxiao.gif" alt="偷笑" title="偷笑" /></li>
            <li><img src="/myweibo/Public/images/phiz/qinqin.gif" alt="亲亲" title="亲亲" /></li>
            <li><img src="/myweibo/Public/images/phiz/shengbin.gif" alt="生病" title="生病" /></li>
            <li><img src="/myweibo/Public/images/phiz/taikaixin.gif" alt="太开心" title="太开心" /></li>
            <li><img src="/myweibo/Public/images/phiz/ldln.gif" alt="懒得理你" title="懒得理你" /></li>
            <li><img src="/myweibo/Public/images/phiz/youhenhen.gif" alt="右哼哼" title="右哼哼" /></li>
            <li><img src="/myweibo/Public/images/phiz/zuohenhen.gif" alt="左哼哼" title="左哼哼" /></li>
            <li><img src="/myweibo/Public/images/phiz/xiu.gif" alt="嘘" title="嘘" /></li>
            <li><img src="/myweibo/Public/images/phiz/shuai.gif" alt="衰" title="衰" /></li>
            <li><img src="/myweibo/Public/images/phiz/weiqu.gif" alt="委屈" title="委屈" /></li>
            <li><img src="/myweibo/Public/images/phiz/tu.gif" alt="吐" title="吐" /></li>
            <li><img src="/myweibo/Public/images/phiz/dahaqian.gif" alt="打哈欠" title="打哈欠" /></li>
            <li><img src="/myweibo/Public/images/phiz/baobao.gif" alt="抱抱" title="抱抱" /></li>
            <li><img src="/myweibo/Public/images/phiz/nu.gif" alt="怒" title="怒" /></li>
            <li><img src="/myweibo/Public/images/phiz/yiwen.gif" alt="疑问" title="疑问" /></li>
            <li><img src="/myweibo/Public/images/phiz/canzui.gif" alt="馋嘴" title="馋嘴" /></li>
            <li><img src="/myweibo/Public/images/phiz/baibai.gif" alt="拜拜" title="拜拜" /></li>
            <li><img src="/myweibo/Public/images/phiz/sikao.gif" alt="思考" title="思考" /></li>
            <li><img src="/myweibo/Public/images/phiz/han.gif" alt="汗" title="汗" /></li>
            <li><img src="/myweibo/Public/images/phiz/kun.gif" alt="困" title="困" /></li>
            <li><img src="/myweibo/Public/images/phiz/shuijiao.gif" alt="睡觉" title="睡觉" /></li>
            <li><img src="/myweibo/Public/images/phiz/qian.gif" alt="钱" title="钱" /></li>
            <li><img src="/myweibo/Public/images/phiz/shiwang.gif" alt="失望" title="失望" /></li>
            <li><img src="/myweibo/Public/images/phiz/ku.gif" alt="酷" title="酷" /></li>
            <li><img src="/myweibo/Public/images/phiz/huaxin.gif" alt="花心" title="花心" /></li>
            <li><img src="/myweibo/Public/images/phiz/heng.gif" alt="哼" title="哼" /></li>
            <li><img src="/myweibo/Public/images/phiz/guzhang.gif" alt="鼓掌" title="鼓掌" /></li>
            <li><img src="/myweibo/Public/images/phiz/yun.gif" alt="晕" title="晕" /></li>
            <li><img src="/myweibo/Public/images/phiz/beishuang.gif" alt="悲伤" title="悲伤" /></li>
            <li><img src="/myweibo/Public/images/phiz/zuakuang.gif" alt="抓狂" title="抓狂" /></li>
            <li><img src="/myweibo/Public/images/phiz/heixian.gif" alt="黑线" title="黑线" /></li>
            <li><img src="/myweibo/Public/images/phiz/yinxian.gif" alt="阴险" title="阴险" /></li>
            <li><img src="/myweibo/Public/images/phiz/numa.gif" alt="怒骂" title="怒骂" /></li>
            <li><img src="/myweibo/Public/images/phiz/xin.gif" alt="心" title="心" /></li>
            <li><img src="/myweibo/Public/images/phiz/shuangxin.gif" alt="伤心" title="伤心" /></li>
        </ul>
    </div>
<!--==========表情==========-->

<!--[if IE 6]>
    <script type="text/javascript" src="/myweibo/Public/Js/DD_belatedPNG_0.0.8a-min.js"></script>
    <script type="text/javascript">
