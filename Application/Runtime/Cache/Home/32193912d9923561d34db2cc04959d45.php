...
<head>
	...
	<title>修改个人资料</title>
	<link rel="stylesheet" href="/myweibo/Public/Css/nav.css" />
	<link rel="stylesheet" href="/myweibo/Public/Css/edit.css" />
    ...
    <script type='text/javascript' src='/myweibo/Public/Js/city.js'></script>
	<script type='text/javascript' src='/myweibo/Public/Js/edit.js'></script>
    <script type="text/javascript" src='/myweibo/Public/Uploadify/jquery.uploadify.min.js'></script>
    
    <script type="text/javascript" src="/myweibo/Public/Js/jquery-validate.js"></script>
    ...
    <!--=====右侧=====-->
    	<div id='right'>
    		...
    		<div class='form hidden'>
    			<form action="<?php echo U('editFace');?>" method='post'>
	    			<div class='edit-face'>
	    				<img src="
                        <?php if($user["face180"]): ?>/myweibo/Uploads/Face/<?php echo ($user["face180"]); ?>
                        <?php else: ?>
                            /myweibo/Public/Images/noface.gif<?php endif; ?>" width='180' height='180' id='face-img'/>
	    				<p>
