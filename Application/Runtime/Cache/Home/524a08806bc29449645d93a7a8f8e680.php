...
<head>
	...
	<title>微博注册</title>
	<link rel="stylesheet" href="/myweibo/Public/Css/regis.css" />
	...
	<script type='text/javascript'>
 	...
 	<script type="text/javascript" src="/myweibo/Public/Js/register.js"></script> 
 </head>
<body>
	<div id='logo'></div>
	<div id='reg-wrap'>
		<form action="<?php echo U('checkRegis');?>" method='post' name='register'>
			<fieldset>
				<legend>用户注册</legend>
				<p>
