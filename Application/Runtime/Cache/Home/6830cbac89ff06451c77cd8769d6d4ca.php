...
<head>
	...
	<link rel="stylesheet" href="/myweibo/Public/Theme/<?php echo ($style); ?>/Css/user.css" />
...
<!--==========内容主体==========-->
	...
	<div id='userinfo'>
		<div class='info-list'>
			<div class='info-face'>
				<p>
					<img src="<?php if($userinfo["face180"]): ?>/myweibo/Uploads/Face/<?php echo ($userinfo["face180"]); else: ?>/myweibo/Public/Images/noface.gif<?php endif; ?>" width='180' height='180' alt="<?php echo ($userinfo["username"]); ?>" />
				</p>
				<ul>
					<li>
        ...
        <div id='right'>
        	<dl>
                ...
                <?php if(is_array($follow)): foreach($follow as $key=>$v): ?><dd>
        			...
        			<img src="<?php if($v.face80): ?>/myweibo/Uploads/Face/<?php echo ($v["face80"]); else: ?>/myweibo/Public/Images/noface.gif<?php endif; ?>" alt="<?php echo ($v["username"]); ?>" width='50' height='50'/>
        			</a>
        			<p>
        				<a href="<?php echo U('/' . $v['uid']);?>"><?php echo ($v["username"]); ?></a>
        			</p>
