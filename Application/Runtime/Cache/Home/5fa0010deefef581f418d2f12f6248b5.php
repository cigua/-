...
<head>
	...
	<link rel="stylesheet" href="/myweibo/Public/Theme/<?php echo ($style); ?>/Css/sech_user.css" />
...
<!--==========内容主体==========-->
    ...
    <!--==========创建分组==========-->
        <div id='right'>
    		...
    		<div id='sech'>
    			<div>
	    			<form action="<?php echo U('sechUser');?>" method='get' name='search'>
    		...
    		<?php if(isset($result)): ?><div id='content'>
    			<?php if($result): ?><div class='view_line'>
	                <strong>用户</strong>
	                <span>总共搜索到<?php echo ($count); ?>结果</span>
	            </div>
	            <ul>
	            	<?php if(is_array($result)): foreach($result as $key=>$v): ?><li>
						<dl class='list-left'>
							<dt>
								<img src="
								<?php if($v["face80"]): ?>/myweibo/Uploads/Face/<?php echo ($v["face80"]); ?>
								<?php else: ?>
									/myweibo/Public/Images/noface.gif<?php endif; ?>" width='80' height='80'/>
							</dt>
							<dd>
...
<!--==========内容主体结束==========-->
 <div id="bottom" style='margin-top:0px; border-top:1px solid #ccc'>
        ...
        <div id="copy">
            <div>
                <p>
                    版权所有： 京ICP备10027771号-1 站长统计 All rights reserved, chjweibo.cn services for Beijing 2008-2012 
                </p>
            </div>
        </div>
    </div>
